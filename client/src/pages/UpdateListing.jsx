...
export default function CreateListing() {
  ...
  //Images select krne ke baad submit ka function.
  ...
  const handleRemoveImage = (index) => {
    setFormData({
      ...formData,// Keeping the prev info. inside the form data
          ...
          {/* To show the images on the screen */}
          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
              <div key={url} className="flex justify-between p-3 border items-center">
                <img src={url} alt='listing image' className='w-40 h-20 object-cover rounded-lg' />
                <button 
                  type='button'
