...
export default function Profile() {
  ...
  const[userListings, setUserListings] = useState([]); // For showing user listings
...
// For deleting the listing
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p className="text-red-700 mt-5">{showListingsError ? 'Error showing Listings, User not found' : ''}</p>
